...
public class Employee {
	...
	public Employee(String employeeId, Salary salary, double totalIncrement, LocalDate dateOfJoining, String jobRole,
			Candidate candidate, Branch branch, Department department) {
		super();
	...
	@Override
	public int hashCode() {
		return Objects.hash(DateOfJoining, branch, candidate, department, employeeId, jobRole, salary, totalIncrement);
	}
